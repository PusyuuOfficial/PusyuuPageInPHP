      ...
      <section class="section">
        <article>
          ...
          <ol class="marukado_waku">
            ...
            <li>フィルムケースサイズの筒</li>
            <li>ゲルマニウムダイオード</li>
            <li>オーディオジャック※両耳で聞きたい場合はステレオジャック</li>
            <li>セラミックイヤホン</li>
            <li>アンプ付きスピーカー</li>
            <li>入れ物（タッパーなど）</li>
            <li>ねじナットセット</li>
          ...
          <h3>テストに動かして見よう</h3>
          <p>まずもうひとつのポリバリコンの端子のあまっているほうに100mの銅線を壁などに取り付けます。 つぎにコイルの反対側に、アース線をつけます、そして床にたらします。 その後に、オーディオジャックにセラミックイヤホンまたはアンプつきスピーカーを接続します。</p>
          <h3>聞こえるか選局してみよう</h3>
          <p>まず一つ目のポリバリコンをゆっくりまわし聞こえるかを探ります。 聞こえたら。混線してる場合もあるのでその場合は二つ目のポリバリコンをまわし聞こえやすいとこまでまわします。</p>
          <h3>聞こえなかった場合の対処法</h3>
          <p>まず余分なショートをしてないか確認をする。 つなげ間違いを確認する。 コイルの巻き数を変えてみる。 アンテナやアースなどの付ける場所を変えてみる。 ※アンテナを窓の冊子や鍵に挟み込むと聞こえるかも知れません。</p>
          <h3>改造！！</h3>
