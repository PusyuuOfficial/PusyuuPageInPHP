    ...
    <div class="main_yohaku">
      <section class="section">
        ...
        <ol class="marukado_waku">
          <li><a href="#p1">しつこいとは？</a></li>
          <li><a href="#p2">しつこさを知るために</a></li>
          <li><a href="#p3">結果</a></li>
        </ol>
        <article class="article" id="p1">
          ...
          <p>しつこいとは何、そしてなぜ起きるのか、ふと疑問に思ったのでまぁメモ書き程度ですが、ブログにしました。 しつこい、それは嫌と感じるほどに、付きまとうあるいは物事を聞くまたは言うこと、なんだか嫌がらせに似ているが、少し違ってくる。</p>
          <p>引用goo辞書↓</p>
          </blockquote>
          <p> １ 色・味・においなどが濃厚すぎて、後に残る感じである。くどい。「脂が多くて―・い味」 ２ 物事にこだわって煩わしい感じである。また、つきまとってうるさい。執念深い。「―・く追いまわす」「―・い男」 </p>
          </blockquote>
          <p>引用しました。</p>
        </article>
        <article class="article" id="p2">
          ...
          <p>私は、しつこさとは何かを知るためにいろいろな人に聞きましたしそれをシミュレーションもしました、ですがなんだかしっくりきませんでした。 でもこんなことをしているうちに、理由を聞くこと自体にしつこさを生んでいる気がしました。なのでこの方法は断念。 ですが、上記のことをやっているうちに気が付いたのが、人によって個人差があり、価値観などで変動することがわかりました。</p>
        </article>
